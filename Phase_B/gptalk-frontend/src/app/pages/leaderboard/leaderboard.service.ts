...
export class LeaderboardService {
   ...
   */
  getLeaderboard(language: Language): Observable<{ top3Users: LeadboardRow[]; top4To10Users: LeadboardRow[] }> {
    const headers = new HttpHeaders().set('language', language);
    const { href } = new URL(`leaderboard`, this.apiUrl);
    return this.http.get<{ top3Users: LeadboardRow[]; top4To10Users: LeadboardRow[] }>(href, { headers });
  }
}
