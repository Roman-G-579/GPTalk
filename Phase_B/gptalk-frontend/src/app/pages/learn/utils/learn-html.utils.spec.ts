...
describe('LearnHtmlUtils', () => {
  ...
  describe('highlightMistakes', () => {
    ...
    it('should highlight all words if none match', () => {
      ...
      expect(result).toBe('<strong>i</strong> <strong>dont</strong> <strong>know</strong> <strong>the</strong> <strong>answer</strong>');
    });
    ...
    it('should handle input longer than the answer by highlighting extra words', () => {
      ...
      expect(result).toBe('this is a test <strong>with</strong> <strong>extra</strong> <strong>words</strong>');
    });
