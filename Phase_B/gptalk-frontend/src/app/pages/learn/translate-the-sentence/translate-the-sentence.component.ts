...
@Component({
	...
	standalone: true,
	imports: [ReactiveFormsModule, Button, TooltipModule],
...
export class TranslateTheSentenceComponent implements AfterViewInit {
	...
	submitAnswer() {
		...
		this.lrn.setExerciseResult(
			this.vrf.verifyTranslateSentence(this.inputText, this.exerciseData, this.penalties),
		);
